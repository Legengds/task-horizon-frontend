...
export const createTask = (taskData) => {
  return request.post('/task/create_task', {
    taskData: {
...
export const getTask = (taskId) => {
  return request.get('/task/get_task', {
...
export const getTaskList = (params) => {
  return request.get('/task/task_list', {
    params: {
...
export const updateTask = (taskData) => {
  return request.post('/task/set_task', {
...
export const getUserTasks = (userId, status) => {
  return request.get('/task/user_task_list', {
